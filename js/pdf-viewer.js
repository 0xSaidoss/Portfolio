/* ⚠️ Code protégé — 0xSaidoss Portfolio */
!function(){
var _$=['\x63\x6f\x6e\x73\x6f\x6c\x65'];
if(window[_$[0]]&&(window[_$[0]]['\x6c\x6f\x67']=function(){}));
var _chk=setInterval(function(){
  var t=new Date();var d=t-0;
  (function(){}['constructor']('debugger')());
  if(new Date()-t>50){clearInterval(_chk);document.body.style.display='none';setTimeout(()=>location.reload(),500)}
},2500);
}();
/* ============================================================
